...
#define DRIVER_NAME	"anacapa_scmcpld"
...
static const struct i2c_device_id anacapa_scmcpld_id[] = {
	{DRIVER_NAME, 0},
	{},
};
MODULE_DEVICE_TABLE(i2c, anacapa_scmcpld_id);

static struct i2c_driver anacapa_scmcpld_driver = {
	...
	.id_table = anacapa_scmcpld_id,
};
module_i2c_driver(anacapa_scmcpld_driver);
