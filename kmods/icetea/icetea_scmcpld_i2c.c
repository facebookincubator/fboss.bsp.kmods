...
#define DRIVER_NAME	"icetea_scmcpld"
...
static const struct i2c_device_id icetea_scmcpld_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
MODULE_DEVICE_TABLE(i2c, icetea_scmcpld_id);
...
static struct i2c_driver icetea_scmcpld_driver = {
	...
	.id_table = icetea_scmcpld_id,
};
module_i2c_driver(icetea_scmcpld_driver);
