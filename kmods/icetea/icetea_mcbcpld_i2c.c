...
#define DRIVER_NAME	"icetea_mcbcpld"
...
static const struct i2c_device_id icetea_mcbcpld_id[] = {
	{DRIVER_NAME, 0},
	{},
};
MODULE_DEVICE_TABLE(i2c, icetea_mcbcpld_id);
...
static struct i2c_driver icetea_mcbcpld_driver = {
	.class = I2C_CLASS_HWMON,
	.driver = {
		.name = DRIVER_NAME,
	},
	.probe = mcbcpld_probe,
	.id_table = icetea_mcbcpld_id,
};
module_i2c_driver(icetea_mcbcpld_driver);
