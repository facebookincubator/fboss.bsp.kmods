...
#define DRIVER_NAME	"icecube_piccpld"
...
static const struct i2c_device_id icecube_piccpld_id[] = {
	{DRIVER_NAME, 0},
	{},
};
MODULE_DEVICE_TABLE(i2c, icecube_piccpld_id);
...
static struct i2c_driver icecube_piccpld_driver = {
	.class = I2C_CLASS_HWMON,
	.driver = {
		.name = DRIVER_NAME,
	},
	.probe = piccpld_probe,
	.id_table = icecube_piccpld_id,
};
module_i2c_driver(icecube_piccpld_driver);
