...
#define DRIVER_NAME	"icecube_fancpld"
...
/* MCBCPLD_FAN id */
static const struct i2c_device_id icecube_fancpld_i2c_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
MODULE_DEVICE_TABLE(i2c, icecube_fancpld_i2c_id);
...
static struct i2c_driver icecube_fancpld_i2c_driver = {
	...
	.id_table = icecube_fancpld_i2c_id,
};

module_i2c_driver(icecube_fancpld_i2c_driver);
