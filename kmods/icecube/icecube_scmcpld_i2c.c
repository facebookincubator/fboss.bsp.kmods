...
#define DRIVER_NAME	"icecube_scmcpld"
...
static const struct i2c_device_id icecube_scmcpld_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
MODULE_DEVICE_TABLE(i2c, icecube_scmcpld_id);
...
static struct i2c_driver icecube_scmcpld_driver = {
	...
	.id_table = icecube_scmcpld_id,
};
module_i2c_driver(icecube_scmcpld_driver);
