...
static const struct i2c_device_id bp4f_adm1275_id[] = {
	{ "bp4f_adm1075", adm1075 },
	{ "bp4f_adm1272", adm1272 },
	{ "bp4f_adm1273", adm1273 },
	{ "bp4f_adm1275", adm1275 },
	{ "bp4f_adm1276", adm1276 },
	{ "bp4f_adm1278", adm1278 },
	{ "bp4f_adm1281", adm1281 },
	{ "bp4f_adm1293", adm1293 },
	{ "bp4f_adm1294", adm1294 },
	{ }
};
MODULE_DEVICE_TABLE(i2c, bp4f_adm1275_id);
...
static int adm1275_probe(struct i2c_client *client)
{
	...
	for (mid = bp4f_adm1275_id; mid->name[0]; mid++) {
		if (strlen(mid->name) <= 5)
			continue;
		/* The bp4f_adm1275_id table names are prefixed with "bp4f_".
		 * This prefix is being skipped during comparison.
		 */
		if (!strncasecmp((mid->name + 5), block_buffer, strlen(mid->name + 5)))
			break;
	}
	if (!mid->name[0]) {
