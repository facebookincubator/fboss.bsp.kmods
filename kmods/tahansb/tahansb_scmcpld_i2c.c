...
#define DRIVER_NAME	"tahansb_scmcpld"
...
static const struct i2c_device_id tahansb_scmcpld_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
MODULE_DEVICE_TABLE(i2c, tahansb_scmcpld_id);
...
static struct i2c_driver tahansb_scmcpld_driver = {
	...
	.id_table = tahansb_scmcpld_id,
};
module_i2c_driver(tahansb_scmcpld_driver);
