...
#define DRIVER_NAME	"tahansb_mcbcpld"
...
static const struct i2c_device_id tahansb_mcbcpld_id[] = {
	{DRIVER_NAME, 0},
	{},
};
MODULE_DEVICE_TABLE(i2c, tahansb_mcbcpld_id);
...
static struct i2c_driver tahansb_mcbcpld_driver = {
	.class = I2C_CLASS_HWMON,
	.driver = {
		.name = DRIVER_NAME,
	},
	.probe = mcbcpld_probe,
	.id_table = tahansb_mcbcpld_id,
};
module_i2c_driver(tahansb_mcbcpld_driver);
