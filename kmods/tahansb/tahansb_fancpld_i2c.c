...
/* Fan PWM is defined as 0 to 64 mapped to 0 to 100%, multiplied by 1.56% */
...
static int mcbfan_pwm_input_read(struct device *dev, int channel, long *val)
{
	 ...
	 * actual PWM is calculated by multiplying 1.56%
...
static const struct hwmon_channel_info *mcbfan_info[] = {
	HWMON_CHANNEL_INFO(fan,  // 4 fans x 2 tach (f&r)
...
/* MCBCPLD_FAN id */
static const struct i2c_device_id tahansb_fancpld_i2c_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
MODULE_DEVICE_TABLE(i2c, tahansb_fancpld_i2c_id);
...
static struct i2c_driver tahansb_fancpld_i2c_driver = {
	...
	.id_table = tahansb_fancpld_i2c_id,
};

module_i2c_driver(tahansb_fancpld_i2c_driver);
